...
const Spells = () => {
    const { favorites, toggleFavorite, spells, setSpells } = useContext(appContext);
    ...
    return (
        <div className="px-24">
            <h3 className="flex justify-start text-2xl mb-3">All Spells</h3>
            {loading ? (
                <ul className="grid grid-cols-4 gap-4 z-0">
                    {Array(50).fill(null).map((_, index) => (
                        <div key={index} className="bg-white p-4 cursor-pointer flex flex-col items-start">
                ...
                <ul className="grid grid-cols-4 gap-4 z-0">
                    {spells.map((spell) => (
                        <div key={spell.index} className="bg-white shadow-sm rounded-lg p-4 cursor-pointer flex flex-col items-start relative">
                            <div className="flex">
                            ...
                            <p><span className="text-gray-500">Level:</span> {spell.level}</p>
                        </div>
                    ))}
                </ul>
            ) : (
